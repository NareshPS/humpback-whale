...
if __name__ == '__main__':
    ...
    processed_input_labels_file = "{}{}".format(input_labels, constants.PROCESSED_INPUT_LABELS_POSTFIX)
    ...
    for _, row in tqdm(input_label_df.iterrows(), total = len(input_label_df), desc = 'Augmenting images'):
        ...
        target_image_names = ["{}-{}.{}".format(image_name, index, constants.PROCESSED_IMAGE_FILE_EXTENSION) for index in range(len(augmented_objs) + 1)]
